"""
Django settings for test_nilam_45447 project.
...
ROOT_URLCONF = 'test_nilam_45447.urls'
...
WSGI_APPLICATION = 'test_nilam_45447.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_nilam_45447 API",
    "DESCRIPTION": "API documentation for test_nilam_45447 App",
    "VERSION": "v1",
}
